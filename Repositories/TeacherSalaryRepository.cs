...
public class TeacherSalaryRepository : BaseRepository
{
    public TeacherSalaryRepository(IConfiguration configuration) : base(configuration)
    {
    }
