...
public class MaterialTypeRepository : BaseRepository
{
    public MaterialTypeRepository(IConfiguration configuration) : base(configuration)
    {
    }
