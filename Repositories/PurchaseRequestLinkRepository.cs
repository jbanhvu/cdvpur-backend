...
public class PurchaseRequestLinkRepository : BaseRepository
{
    public PurchaseRequestLinkRepository(IConfiguration configuration) : base(configuration)
    {
    }
    ...
    public async Task<List<Dictionary<string, object?>>> GetAllAsync()
    {
        return await ExecuteStoredProcedureAsync(
            "CDV_PurchaseRequestLink_Select",
