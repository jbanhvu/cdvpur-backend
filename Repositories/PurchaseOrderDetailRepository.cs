...
public class PurchaseOrderDetailRepository : BaseRepository
{
    public PurchaseOrderDetailRepository(IConfiguration configuration) : base(configuration)
    {
    }
    ...
    public async Task<List<Dictionary<string, object?>>> GetAllAsync()
    {
        return await ExecuteStoredProcedureAsync(
            "Sol_PurchaseOrderDetail_Select",
    ...
    {
        return await ExecuteStoredProcedureAsync(
            "Sol_PurchaseOrderDetail_Upsert",
            parameters);
    }
    ...
    {
        return await ExecuteStoredProcedureAsync(
            "Sol_PurchaseOrderDetail_Delete",
            new SqlParameter("@Id", id),
